...
## AI Team Configuration (autogenerated by team-configurator, 2025-11-19)
...
| **Database/API/Services**          | Use general development  | Prisma schema, service layer, permission checks            |
...
"@code-reviewer Review the new list sharing API routes for security issues and service layer compliance"

# Performance investigation
"@performance-optimizer Analyze why the lists page is loading slowly, check for N+1 queries"

# Documentation after feature
"@documentation-specialist Update API docs to reflect the new gift card management endpoints"
```
